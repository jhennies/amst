...
sys.path.append('/mnt/schwab/hennies/src/github/')
...
source = '/mnt/schwab/hennies/datasets/empiar_upload/20140801_hela-wt_xy5z8nm_as/raw_8bit/'
...
template_source = '/mnt/schwab/hennies/datasets/20140801_Hela-wt_xy5z8nm_AS/20140801_hela-wt_xy5z8nm_as_full_8bit/'
# Where to save the results
# results_folder = '/path/to/some/results/folder/'
results_folder = '/mnt/schwab/hennies/tmp/amst_test/'
...
if __name__ == '__main__':
    ...
    template_align.align_on_template(
        source,
        sift_target,
        source_range=np.s_[350:450],
        template_source_range=np.s_[350:450],
